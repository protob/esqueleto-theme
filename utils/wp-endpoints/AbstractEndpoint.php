<?php namespace Esq;
require_once __DIR__ . "/Endpoints/Filters.php";

use Esq\Endpoints\Filters;
use Esq\Endpoints\Contract;

/**
 * Class that creates the default behavior used to register a new endpoint and
 * also the same logic that is used across all Esq PHP modules.
 *
 * @package Esq;
 */
abstract class AbstractEndpoint {
	...
	private function set_variables() {
		$this->namespace = apply_filters( Filters::API_NAMESPACE, 'Esq', $this->endpoint );
